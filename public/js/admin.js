        ...
        try {
            ...
            if (collTbody && Array.isArray(colData)) {
                ...
                if (displayData.length > 0) {
                    ...
                    collTbody.innerHTML = '<tr><td colspan="6" style="text-align:center;">No recent collection records found.</td></tr>';
                }
            }
    ...
    async function loadAgentsList() {
        try {
            ...
            if (agents.length > 0) {
                ...
                tbody.innerHTML = '<tr><td colspan="7" style="text-align:center;">No agents registered in system.</td></tr>';
            }
        } catch (e) {
            console.error(e);
        }
